...
const Navbar = () => {
  ...
  return (
    ...
    //         <BiSolidContact className="absolute left-48 min-h-7 min-w-7 text-white z-10" />
    //       </Link>
    //     </div>
  ...
  <nav className="hidden md:flex items-center gap-10 font-inter pl-[120px]">
    {navItems.map((item) => (
      <NavLink
        ...
        className={({ isActive }) =>
          [
            "text-[14px] font-semibold uppercase whitespace-nowrap transition-colors",
            isActive
              ? "text-[#0a7c1b]"
              : "text-slate-800 hover:text-[#0a7c1b]",
          ].join(" ")
    ...
    {/* ================= DESKTOP CTA ================= */}
   {/* <div className="hidden md:flex flex-1 w-[600px]">
  <Link
    to="/contact"
    className="
      relative flex
  ...
  >
    ...
    <div
      aria-hidden
      className="absolute inset-0 bg-gradient-to-r from-[#21CE06] via-[#119605] to-[#005505] w-[400px]"
      style={{
        clipPath:
          "polygon(100% 0, 100% 50%, 100% 100%, 0% 100%, 6% 50%, 0% 0%)",
      }}
    />
    ...
    <BiSolidContact className="relative z-10 h-16 w-4" />
  </Link>
</div> */}
